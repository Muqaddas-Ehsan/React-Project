...
import fc21 from "../images/fc21.webp";
import fc22 from "../images/fc22.webp";
import fc23 from "../images/fc23.webp";
import fc24 from "../images/fc24.webp";
import fc25 from "../images/fc25.webp";
function Featuredcart5() {
                ...
                <div className="container">
                    <div className="row mt-5">
                        <div className="col-md-6">
                            <img className="img-fluid pb-3" src={fc21} alt="error" id="MainImg" />

                            <div className="small-img-group d-flex justify-content-between">
                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc22} alt="error" />
                                </div>

                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc23} alt="error" />
                                </div>

                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc24} alt="error" />
                                </div>

                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc25} alt="error" />
                                </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                <h3 className="mt-3">NIGHT BLOOM-2PC KHADDAR PRINTED SUIT</h3>
                                <h4 className="text-left ml-3">₨ 2,130 <small>PKR</small></h4>
                                <p className="text-left ml-4"><span className="font-weight-bold">SKU:</span>1000000124904</p>
                            ...
                            <div className="product_details mt-3" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                ...
                                <p className="ml-4 text-left">DIGITAL PRINTED KHADDAR SHIRT</p>
