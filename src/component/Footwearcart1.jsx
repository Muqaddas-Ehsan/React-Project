...
import sh3 from "../images/sh3.webp";
import sh4 from "../images/sh4.webp";
function Footwearcart1() {
                    ...
                    <div className="row mt-5">
                            ...
                            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={sh1} alt="First slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh2} alt="Second slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh3} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh4} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif",fontSize:12 }}>
                                <h3 className="mt-3">ALORA</h3>
                                <h4 className="text-left ml-3">₨ 3,550 <small>PKR</small></h4>
                                ...
                                <p className="text-left  ml-4"><span className="font-weight-bold">COLOR:</span>GREY</p>
                                <h6 className="text-left ml-4">COLOR  </h6>
                                <button className="btn d-flex align-start ml-4 text-white" style={{ backgroundColor: "#000000" }}>GREY</button>
                            ...
                            <div className="product_details mt-3" style={{ fontFamily: "Century Gothic, sans-serif",fontSize:12 }}>
                                ...
                                <p className="ml-4 text-left">Alora features a gray khussa bedazzled to lift your mood as well as your attire with the right dash of pink threadwork</p>
                            </div>
                        </div>
                    </div>
                </div>
