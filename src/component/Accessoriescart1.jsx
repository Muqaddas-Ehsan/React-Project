                    ...
                    <div className="row mt-5">
                            ...
                            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={a1} alt="First slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={a2} alt="Second slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={a3} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                <h3 className="mt-3">SAANJH-ORGANZA DUPATTA</h3>
                                <h4 className="text-left ml-3">₨ 1,460 <small>PKR</small></h4>
                                <p className="text-left ml-4"><span className="font-weight-bold">SKU:</span>1000000123337</p>
                                ...
                                <p className="text-left  ml-4"><span className="font-weight-bold">COLOR:</span>MULTI</p>
                            ...
                            <div className="product_details mt-3" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                ...
                                <h6 className="ml-4 text-left">READY TO WEAR DUPATTA</h6>
                            </div>
                        </div>
                    </div>
                </div>
...
export default Accessoriescart1;