...
import sh26 from "../images/sh26.webp";
import sh27 from "../images/sh27.webp";
function Footwearcart7() {
                    ...
                    <div className="row mt-5">
                            ...
                            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={sh24} alt="First slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh25} alt="Second slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh26} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh27} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif",fontSize:12 }}>
                                <h3 className="mt-3">LUKE-1</h3>
                                <h4 className="text-left ml-3">₨ 4,160 <small>PKR</small></h4>
                            ...
                            <div className="product_details mt-3" style={{ fontFamily: "Century Gothic, sans-serif",fontSize:12 }}>
                                ...
                                <p className="ml-4 text-left">Luke heel features a pointed front suede base in blue with a strap at the back and a diamante brooch on top.</p>
                            </div>
                        </div>
                    </div>
                </div>
