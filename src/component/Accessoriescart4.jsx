                    ...
                    <div className="row mt-5">
                            ...
                            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={a10} alt="First slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={a11} alt="Second slide" style={{ height: 600 }} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                <h3 className="mt-3">SHAWL-SHW0105</h3>
                                <h4 className="text-left ml-3">₨ 1,350 <small>PKR</small></h4>
                                <p className="text-left ml-4"><span className="font-weight-bold">SKU:</span>1000000121285</p>
                            ...
                            <div className="product_details mt-3" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                ...
                                <h6 className="ml-4 text-left">Winter Shawl With Gold Texture</h6>
                                <h6 className="ml-4 text-left font-weight-bold">STYLE TIP</h6>
                                <p className="ml-4 text-left">This Classic Striped Winter Shawl in a Subtle Limestone Shade is Perfect to Keep you Warm and Trendy at the Same Time. The Shawl Pairs Best with Ensembles in Shades of Green and Brown.</p>
