...
import fc11 from "../images/fc11.webp";
import fc12 from "../images/fc12.webp";
import fc13 from "../images/fc13.webp";
import fc14 from "../images/fc14.webp";
import fc15 from "../images/fc15.webp";
function Featuredcart3() {
                ...
                <div className="container">
                    <div className="row mt-5">
                        <div className="col-md-6">
                            <img className="img-fluid pb-3" src={fc11} alt="error" id="MainImg" />

                            <div className="small-img-group d-flex justify-content-between">
                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc12} alt="error" />
                                </div>

                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc13} alt="error" />
                                </div>

                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc14} alt="error" />
                                </div>

                                <div className="small-img-col">
                                    <img className="img-fluid small-img" id="small" src={fc15} alt="error" />
                                </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif" }}>
                                <h3 className="mt-3">ROSEATE PEARL-3PC LAWN EMBRIODERED SUIT</h3>
                                <h4 className="text-left ml-3">₨ 6,950 <small>PKR</small></h4>
                                <p className="text-left ml-4"><span className="font-weight-bold">SKU:</span>1000000125436</p>
