...
import sh15 from "../images/sh15.webp";
import sh16 from "../images/sh16.webp";
function Footwearcart4() {
                    ...
                    <div className="row mt-5">
                            ...
                            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={sh13} alt="First slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                    <img class="d-block w-100" src={sh14} alt="Second slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh15} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={sh16} alt="Third slide" style={{ height: 600 }} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-6">
                            <div className="detail" style={{ fontFamily: "Century Gothic, sans-serif",fontSize:12 }}>
                                <h3 className="mt-3">EVANDER-2</h3>
                                <h4 className="text-left ml-3">₨ 3,410 <small>PKR</small></h4>
                                ...
                                <p className="text-left  ml-4"><span className="font-weight-bold">COLOR:</span>NUDE</p>
                                <h6 className="text-left ml-4">COLOR  </h6>
                                <button className="btn d-flex align-start ml-4 text-white" style={{ backgroundColor: "#000000" }}>NUDE</button>
                            ...
                            <div className="product_details mt-3" style={{ fontFamily: "Century Gothic, sans-serif",fontSize:12 }}>
                                ...
                                <p className="ml-4 text-left">A contemporary take on flats, the pink hued Evander comes with sequined straps and a cute little knot to compliment your daily looks.</p>
                            </div>
                        </div>
                    </div>
                </div>
